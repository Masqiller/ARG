...
```mermaid
graph LR
    center["Recursively unwrap declarator to find the innermost identifier [C]."]:::centerNode
    center -->|"rationale_for"| N_graphify_extract_get_c_func_name["_get_c_func_name[]"]
