...
# test_collect_files_handles_circular_symlinks()
...
```mermaid
graph LR
    center["test_collect_files_handles_circular_symlinks[]"]:::centerNode
...
```dataview
LIST
FROM [[test_collect_files_handles_circular_symlinks()]]
```
