...
graph LR
    ...
    center -->|"rationale_for"| N_graphify_analyze_rationale_221["Cross-file edges between real code/doc entities, ranked by a composite     surpr"]
