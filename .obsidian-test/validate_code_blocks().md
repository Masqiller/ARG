...
```mermaid
graph LR
    center["validate_code_blocks[]"]:::centerNode
    ...
    center -->|"calls"| N_scripts_validate_extract_code_blocks["extract_code_blocks[]"]
...
- [[extract_code_blocks()]] - `calls` [EXTRACTED]
