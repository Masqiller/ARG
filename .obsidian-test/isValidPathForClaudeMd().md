...
```mermaid
graph LR
    center["isValidPathForClaudeMd[]"]:::centerNode
    center -->|"contains"| N_vendor_claude_mem_src_utils_claude_md_utils_ts["claude-md-utils.ts"]
    center -->|"calls"| N_utils_claude_md_utils_hasconsecutiveduplicatesegments["hasConsecutiveDuplicateSegments[]"]
...
- [[hasConsecutiveDuplicateSegments()]] - `calls` [EXTRACTED]
