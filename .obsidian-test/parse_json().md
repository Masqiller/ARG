...
```mermaid
graph LR
    center["parse_json[]"]:::centerNode
    center -->|"contains"| N_vendor_graphify_worked_example_raw_parser_py["parser.py"]
    center -->|"calls"| N_raw_parser_parse_file["parse_file[]"]
    center -->|"rationale_for"| N_raw_parser_rationale_50["Parse a JSON document into a structured dict."]
    classDef centerNode fill:#4E79A7,stroke:#fff,stroke-width:2px,color:#fff
```

## Outbound Connections
- [[Parse a JSON document into a structured dict.]] - `rationale_for` [EXTRACTED]
