...
```mermaid
graph LR
    center["validate_headings[]"]:::centerNode
    ...
    center -->|"calls"| N_scripts_validate_extract_headings["extract_headings[]"]
...
- [[extract_headings()]] - `calls` [EXTRACTED]
