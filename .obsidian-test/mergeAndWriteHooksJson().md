...
```mermaid
graph LR
    center["mergeAndWriteHooksJson[]"]:::centerNode
    center -->|"contains"| N_vendor_claude_mem_src_services_integrations_windsurfhooksinstaller_ts["WindsurfHooksInstaller.ts"]
    center -->|"calls"| N_integrations_windsurfhooksinstaller_buildhookcommand["buildHookCommand[]"]
...
- [[buildHookCommand()]] - `calls` [EXTRACTED]
