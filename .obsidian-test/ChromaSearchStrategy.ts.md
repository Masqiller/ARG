...
```mermaid
graph LR
    center["ChromaSearchStrategy.ts"]:::centerNode
    ...
    center -->|"contains"| N_strategies_chromasearchstrategy_chromasearchstrategy["ChromaSearchStrategy"]
