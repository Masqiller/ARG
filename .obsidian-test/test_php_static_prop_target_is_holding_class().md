...
# test_php_static_prop_target_is_holding_class()
...
```mermaid
graph LR
    center["test_php_static_prop_target_is_holding_class[]"]:::centerNode
...
```dataview
LIST
FROM [[test_php_static_prop_target_is_holding_class()]]
```
