...
```mermaid
graph LR
    center["PaginationHelper.ts"]:::centerNode
    ...
    center -->|"contains"| N_worker_paginationhelper_paginationhelper["PaginationHelper"]
...
- [[PaginationHelper]] - `contains` [EXTRACTED]
