...
```mermaid
graph LR
    center["_is_code_line[]"]:::centerNode
    ...
    center -->|"rationale_for"| N_scripts_detect_rationale_33["Check if a line looks like code."]
...
- [[Check if a line looks like code.]] - `rationale_for` [EXTRACTED]
