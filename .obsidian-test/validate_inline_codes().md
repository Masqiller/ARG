...
```mermaid
graph LR
    center["validate_inline_codes[]"]:::centerNode
    ...
    center -->|"calls"| N_scripts_validate_extract_inline_codes["extract_inline_codes[]"]
...
- [[extract_inline_codes()]] - `calls` [EXTRACTED]
